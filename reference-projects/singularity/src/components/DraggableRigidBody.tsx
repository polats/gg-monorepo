...
const DraggableRigidBody = React.memo(
  forwardRef<DraggableRigidBodyRef, DraggableRigidBodyProps>((props, ref) => {
    ...
    const getBoxedPosition = useCallback(
      ...
      <group {...props.groupProps}>
        ...
        <RigidBody ref={rigidBodyRef} type={'dynamic'} colliders={'hull'} {...props.rigidBodyProps}>
          {React.cloneElement(props.visibleMesh, {
            ref: (props.visibleComponentRef as any) ?? meshRef,
            key: 'visible',
          })}
        </RigidBody>
      </group>
