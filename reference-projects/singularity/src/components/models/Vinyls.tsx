...
export const VinylsModel = React.memo(
  React.forwardRef<any, DiscModelProps>(({ texturesSrc, ...props }, ref) => {
    ...
    const materials = useMemo(
      () =>
        textures.map(
          (texture) => new THREE.MeshStandardMaterial({ map: texture, side: THREE.DoubleSide })
        ),
      [textures]
    );
