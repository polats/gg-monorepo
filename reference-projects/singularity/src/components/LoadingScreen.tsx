...
export default function LoadingScreen({
  ...
  return shown ? (
    <div
      className="select-none transition-opacity duration-[100ms] ease-[cubic-bezier(1,.01,.9,.97)]"
      style={{ ...styles.container, opacity: animation ? 0 : 1, ...containerStyles }}
    >
      <div>
        <div style={{ ...styles.inner, ...innerStyles }} className="white">
          <p
            className="transition-all duration-[100ms] "
            style={{
