...
export const Branding = (props: any = { onShowSettings: () => {} }) => {
  return (
    <div className="fixed top-5 left-5 z-10 text-black/35">
      <p
        style={{ filter: 'drop-shadow(0px 0px 10px rgba(118, 118, 118, 1))' }}
      ...
      <p
        style={{ filter: 'drop-shadow(0px 0px 10px rgba(118, 118, 118, 1))' }}
        className={`${GeistSans.className} select-none text-sm`}
      >
        by{' '}
        <a href="https://x.com/niccolofanton" target="_blank" className="underline">
          @niccolofanton
        </a>
      </p>

      <a
        className={`${GeistSans.className} fixed z-10 text-xs underline top-4 right-5 text-black/35`}
      ...
      <div className="flex gap-5 pt-3">
        <a className="frame__back" href="https://tympanus.net/codrops/?p=86572">
          Read the tutorial
        </a>
        <a
          className="frame__github"
          href="https://github.com/niccolofanton/codrops-singularity-demo"
        >
          GitHub
        </a>
