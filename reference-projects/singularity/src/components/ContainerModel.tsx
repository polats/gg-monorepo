...
export const generatedPositions = [
  ...
  new THREE.Vector3(-3.3, 17.29, -7.24),
  new THREE.Vector3(1.76, 8.91, 7.82),
  new THREE.Vector3(-1.15, 5.78, 2.83),
  new THREE.Vector3(-3.73, 18.46, 6.17),
  new THREE.Vector3(-8.7, 7.96, -3.83),
  new THREE.Vector3(2.82, 11.15, 7.21),
  new THREE.Vector3(8.1, 2.48, -6.1),
  new THREE.Vector3(-3.15, 4.9, 7.86),
  new THREE.Vector3(0.12, 14.69, -8.2),
  ...
  new THREE.Vector3(5.85, 12.1, 3.41),
  ...
  new THREE.Vector3(-1.78, 18.51, -1.1),
  ...
  new THREE.Vector3(-4.2, 16.4, 1.62),
  new THREE.Vector3(-0.64, 1.85, 2.51),
  new THREE.Vector3(2.29, 10.98, -7.9),
  new THREE.Vector3(-3.94, 1.8, 6.38),
  new THREE.Vector3(5.28, 5.28, -4.67),
  new THREE.Vector3(-8.99, 10.95, -8.96),
  new THREE.Vector3(-6.12, 7.13, 8.6),
  new THREE.Vector3(5.78, 15.1, -4.82),
  new THREE.Vector3(2.72, 7.64, -7.12),
  new THREE.Vector3(5.3, 4.67, 1.91),
  new THREE.Vector3(-4.78, 8.88, -6.19),
  new THREE.Vector3(8.98, 6.7, -4.93),
  new THREE.Vector3(2.94, 18.38, -5.0),
  ...
  new THREE.Vector3(-8.49, 14.76, 4.7),
  new THREE.Vector3(6.13, 2.07, -6.64),
  new THREE.Vector3(2.64, 14.01, 5.43),
  new THREE.Vector3(2.6, 5.1, -0.29),
  new THREE.Vector3(2.66, 14.2, -8.76),
  ...
  new THREE.Vector3(-3.16, 7.15, -2.0),
  ...
  new THREE.Vector3(4.71, 15.0, 1.48),
  new THREE.Vector3(1.04, 10.51, 0.71),
  new THREE.Vector3(7.2, 8.89, 0.73),
  new THREE.Vector3(-0.9, 17.7, 6.4),
  new THREE.Vector3(6.87, 16.43, 2.5),
  ...
  new THREE.Vector3(-1.35, 2.4, -7.51),
  new THREE.Vector3(3.65, 14.03, 3.1),
  new THREE.Vector3(8.5, 12.47, 4.3),
...
export function ContainerModel(
  props: JSX.IntrinsicElements['group'] & { enablePointer?: boolean; lowSetting?: boolean }
) {
  ...
  return (
    <>
      ...
      {logosArray.map((p, i) => {
        return (
          <DraggableRigidBody
            ...
            visibleMesh={<TexturedPlane src={`/logos/${p}`} />}
          />
        );
      })}
      ...
      <DraggableRigidBody
        ...
        visibleMesh={<MarioModel position={[0, 0, 0]} scale={objectScaleSize * 0.14} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        visibleMesh={<ZombieModel scale={objectScaleSize * 0.6} />}
      />
      ...
      <DraggableRigidBody
        ...
        visibleMesh={<Ak47Model scale={objectScaleSize * 0.04} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'ball' }}
        visibleMesh={<ApeModel scale={objectScaleSize * 0.8} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<CarModel scale={objectScaleSize * 0.1} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'ball' }}
        visibleMesh={<ClankModel scale={objectScaleSize * 0.7} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<ControllerModel scale={objectScaleSize * 0.005} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<CrashModel scale={objectScaleSize * 0.01} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        visibleMesh={<DaftpunkModel scale={objectScaleSize * 3.7} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<Deadmau5Model scale={objectScaleSize * 0.05} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<DexterModel scale={objectScaleSize * 0.1} />}
      />
      ...
      <DraggableRigidBody
        ...
        visibleMesh={<GbcModel scale={objectScaleSize * 0.7} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid', density: 10, angularDamping: 0.5 }}
        visibleMesh={<HaloModel scale={objectScaleSize * 1} />}
      />
      <DraggableRigidBody
        {...DraggableRigidBodyProps}
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'ball' }}
        visibleMesh={<KanyeModel scale={objectScaleSize * 2} />}
      />
      <DraggableRigidBody
        {...DraggableRigidBodyProps}
        ...
        visibleMesh={<KlonoaModel scale={objectScaleSize * 0.27} />}
      />
      <DraggableRigidBody
        {...DraggableRigidBodyProps}
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<MinecraftModel scale={objectScaleSize * 1.8} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'ball' }}
        visibleMesh={<RaymanModel scale={objectScaleSize * 1.3} />}
      />
      <DraggableRigidBody
        {...DraggableRigidBodyProps}
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid', density: 10, angularDamping: 0.5 }}
        visibleMesh={<SlyModel scale={objectScaleSize * 1} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<SnakeModel scale={objectScaleSize * 0.13} />}
      />
      <DraggableRigidBody
        {...DraggableRigidBodyProps}
        groupProps={{ position: generatedPositions[78 + 22] }}
        enableSpringJoint={springJoint}
        visibleMesh={<SteveModel scale={objectScaleSize * 0.06} />}
      />
      <DraggableRigidBody
        {...DraggableRigidBodyProps}
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<TankModel scale={objectScaleSize * 0.8} />}
      />
      ...
      <DraggableRigidBody
        ...
        enableSpringJoint={springJoint}
        rigidBodyProps={{ colliders: 'cuboid' }}
        visibleMesh={<ZeldaModel scale={objectScaleSize * 0.05} />}
      />
    </>
  );
}
