...
export const CustomDragControls: ForwardRefComponent<CustomDragControlsProps, THREE.Group> =
      ...
      const bind = useGesture(
        {
          ...
          onDrag: ({ xy: [dragX, dragY], intentional, event }) => {
            ...
            if (autoTransform) {
              ...
              onDrag &&
                onDrag(tempMatrix, deltaLocalMatrix, ref.current.matrixWorld, deltaWorldMatrix);
            }
            invalidate();
          },
          onDragEnd: ({ event }) => {
