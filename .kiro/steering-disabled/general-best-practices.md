...
- **Use Playwright MCP for browser testing**: When testing HTML files, web applications, or any browser-based functionality, use the Playwright MCP tools instead of opening files directly
- **Available Playwright tools**: Use `mcp_playwright_browser_navigate`, `mcp_playwright_browser_snapshot`, `mcp_playwright_browser_click`, and other Playwright MCP tools for interactive testing
- **Benefits**: Playwright MCP provides programmatic browser control, screenshots, accessibility snapshots, and interaction capabilities for thorough testing
- **When to use**: Any time you need to verify visual output, test user interactions, or validate browser-based functionality
