# Reference Games for Goblin Gardens

A curated list of games with relevant mechanics, aesthetics, or themes to study for Goblin Gardens development.
...
- Cave environment procedural generation
- Co-op gameplay feel
...
- Hand-drawn character animation (Flash-based)
- Muted colors with selective saturation
...
- Mobile adaptation (Pikmin Bloom)
- Cute + strategic
...
- [ ] Record first-time user experience (FTUE)
- [ ] Note what makes items feel "precious"
- [ ] Track how tutorials introduce mechanics
- [ ] Observe how community features work
- [ ] Analyze monetization (if applicable)
- [ ] Study color palette usage
- [ ] Note animation principles
- [ ] Check accessibility features
- [ ] Test mobile control schemes

---

## Quick Reference: Which Game for Which Question?

**"How should goblins look?"**
→ Clash of Clans, Goblin Stone, stylized goblin art on Sketchfab

**"How should garden building feel?"**
→ Plants vs. Zombies, Stardew Valley, Animal Crossing

**"What art style for mobile?"**
→ Plants vs. Zombies, Clash of Clans, Vampire Survivors

**"How to make trash feel valuable?"**
→ Recettear, Delicious in Dungeon, goblincore aesthetic

**"How should progression feel?"**
→ Vampire Survivors, Solo Leveling, idle games

**"What should the tone be?"**
→ Orcs Must Die (comedy), Don't Starve (dark whimsy), PvZ (accessible fun)

**"How do swarms/groups work?"**
→ Pikmin, Solo Leveling shadow army, Deep Rock Galactic bugs
